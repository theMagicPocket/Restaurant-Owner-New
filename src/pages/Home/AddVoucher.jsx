...
const AddVoucher = ({ refetch, onClose, voucher}) => {
  ...
  useEffect(() => {
    if (voucher) {
      setFormData({
        ...
        max_discount_amt: voucher.max_discount_amt,
        min_cart_value: voucher.min_cart_value,
        endDate: voucher.validity,
        per_user_usage_limit: voucher.per_user_usage_limit,
  ...
  const handleSubmit = async (e) => {
    ...
    const dataToSend = {
      ...
      ...(voucher ? {} : { type: "HOTEL", id: restaurant_id }),
    };
    ...
    try {
      ...
      if (voucher) {
        setSnackbarMessage("Failed to update voucher, Please try again.");
      } else {
